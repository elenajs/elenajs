define([
     ...
     *
     */
    var _RequestProcessor = declare("elenajs.dispatchers._RequestProcessor", [Stateful], {
        /**
        ...
        processRequest: function(httpDeferredContext) {
            var self = this,
                    req = httpDeferredContext.get('httpRequest'),
                    res = httpDeferredContext.get('httpResponse'),
                    method = req.method,
                    requestData = httpDeferredContext.get('requestData');
