define([
     ...
     * @mixes module:elenajs/dispatchers/_RequestProcessor
     *
     * @example
     * define([
            "dojo/_base/declare",
    ...
    var RequestDispatcher = declare("elenajs.dispatchers.RequestDispatcher", [_Dispatcher, _RequestProcessor], {
         ...
         * 500 status error.
         *
         * @param {!elenajs.HttpDeferred} httpDeferredContext It's the deferred context passed to the
        ...
        dispatch: function(httpDeferredContext) {
            ...
            try {
                self.render(httpDeferredContext);
            } catch (err) {
                httpDeferredContext.signal(err,500);
            }
            return httpDeferredContext;
        },
        /**
         *
         * @param {elenajs.HttpDeferred} httpDeferredContext It's the deferred context that stores
