...
module.exports = function(userConfig) {
    ...
    var defaultConfig = {
        ...
        packages: [{
                name: 'dojo',
                location: pathUtils.dirname(require.resolve('dojo'))
            }],
        trace: {
            ...
            loaderPatch: {
                ...
                eval: function(__text, __urlHint) {
                    try {
                        ...
                        if (!e.__urlHint) {
                            console.error('Error evaluating: ' +  __urlHint);
                        }
                        e.__urlHint = __urlHint;
                        throw e;
                    }
                },
                ...
                getText: function(url, sync, onLoad) {
                    ...
                    onLoad(fs.readFileSync(path.resolve(url), "utf8"));
                },
                nodeRequire: require
            }
        };
        ...
        guardCheckComplete(function() {
            ...
            contextRequire = function(a1, a2, a3, referenceModule, contextRequire) {
                ...
                if (!isArray(a1)) {
                    ...
                    modulesOverride = a1.modulesOverride;
