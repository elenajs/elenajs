...
var amdConfigFactory = {
    ...
    setDefaultOverrides: function(cfg) {
        cfg.modulesOverride = cfg.modulesOverride || {};
        cfg.modulesOverride['dojo/node'] = cfg.modulesOverride['dojo/node'] || 'elenajs/node';
    ...
    createConfig: function(userConfig, packageLocation) {
        ...
        this.setDefaultOverrides(params.config);
