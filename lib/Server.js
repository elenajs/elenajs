...
define(["dojo/node!http",
    ...
    /**
     * Class to create ElenaJs HTTP server
     * @extends elenajs.dispatchers._Dispatcher, elenajs._ErrorRendererMixin
     * @class elenajs.Server
     */
    var Server = declare("elenajs.Server", [_Dispatcher, _ErrorRendererMixin],
            /** @lends elenajs.Server.prototype */ {
                /**
