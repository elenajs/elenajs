define(["./node!http",
    ...
    "dojo/Evented",
    "./node!toobusy"
], function (http, declare, require, _Dispatcher, FSDispatcher, HttpContext, ErrorRenderer, watch, topic, Evented, toobusy) {
    ...
    var Server = declare("elenajs.Server", [_Dispatcher, Evented],
        {
            ...
            constructor: declare.superCall(function (sup) {
                return function () {
                    ...
                    this._sockets = [];
                    if (args[0].dispatchers !== undefined) {
            ...
            serveRequest: function (req, res) {
                ...
                try {
                    if (toobusy()) {
                        httpContext.signal("Server is too busy, retry later!", 503);
                    } else {
